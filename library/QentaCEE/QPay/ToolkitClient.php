...
class ToolkitClient extends ClientAbstract
{
    ...
    /**
     * Creates an instance of QentaCEE_QPay_ToolkitClient object.
    ...
    public function __construct($aConfig = null)
    {
        ...
        if (is_array($aConfig) && isset( $aConfig['QentaCEEQPayConfig'] )) {
            // we only need the QentaCEEQPayConfig here
            $aConfig = $aConfig['QentaCEEQPayConfig'];
        }
     ...
     *
     * @return QentaCEE_QPay_Request_Backend_TransferFund
