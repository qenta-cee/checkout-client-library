...
/**
 * Test class for QentaCEE_QMore_DataStorage_Response_Initiation.
 * Generated by PHPUnit on 2011-12-30 at 09:22:50.
 */
use PHPUnit\Framework\TestCase;

class QentaCEE_QMore_DataStorage_Response_InitiationTest extends TestCase
{
    ...
    {
        $this->_200ErrorResponse();
        $this->assertIsArray($this->object->getErrors());
        foreach ($this->object->getErrors() as $error) {
            $this->assertInstanceOf('QentaCEE_Stdlib_Error', $error);
        }
