...
class QentaCEE_QMore_ModuleTest extends TestCase
{
    public function testClientConfig()
    {
        ...
        $this->assertEquals('QentaCEE_QMore', $aConfig['MODULE_NAME']);
    }
    ...
    public function testUserConfig()
    {
        ...
        $this->assertArrayHasKey('SHOP_ID', $aConfig['QentaCEEQMoreConfig']);
        $this->assertArrayHasKey('LANGUAGE', $aConfig['QentaCEEQMoreConfig']);
        $this->assertArrayHasKey('SECRET', $aConfig['QentaCEEQMoreConfig']);
    }
}
