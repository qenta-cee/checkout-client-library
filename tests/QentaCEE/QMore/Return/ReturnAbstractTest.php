...
/**
 * Test class for QentaCEE_Client_QMore_Return_Abstract.
 */
class QentaCEE_QMore_Return_ReturnAbstractTest extends TestCase
{

    /**
     *
     * @var QentaCEE_QMore_Return_ReturnAbstractTestObject
     */
    protected $object;
    ...
    {
        $this->object = new QentaCEE_QMore_Return_ReturnAbstractTestObject($this->_returnData);
    }
    ...
    public function testGetReturnedButUnsetArrayFields()
    {
        ...
        $object = new QentaCEE_QMore_Return_ReturnAbstractTestObject($returnData);
        $object->getReturned();
