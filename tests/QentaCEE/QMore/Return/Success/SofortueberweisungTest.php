...
class QentaCEE_QMore_Return_Success_SofortueberweisungTest extends TestCase
{

    /**
     * @var QentaCEE_QMore_Return_Success_Sofortueberweisung
     */
    protected $object;
    ...
    {
        $this->object = new QentaCEE\QMore\Returns\Success\Sofortueberweisung($this->_returnData, $this->_secret);
    }
