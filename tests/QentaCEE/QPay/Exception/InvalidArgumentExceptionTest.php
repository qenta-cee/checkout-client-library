...
class InvalidArgumentExceptionTest extends TestCase
{
    ...
    {
        $this->object = new InvalidArgumentException('objectMessage', 666);
    }
    ...
    {
        try {
            throw new InvalidArgumentException('message', 1234);
        } catch (InvalidArgumentException $e) {
    ...
    {
        try {
            throw new InvalidArgumentException('message', 111, $this->object);
        } catch (InvalidArgumentException $e) {
            $this->assertEquals('message', $e->getMessage());
            $this->assertEquals(1234, $e->getCode());
