...
class InvalidResponseExceptionTest extends TestCase
{
    ...
    {
        $this->object = new InvalidResponseException('objectMessage', 666);
    }
    ...
    {
        try {
            throw new InvalidResponseException('message', 1234);
        } catch (InvalidResponseException $e) {
    ...
    {
        try {
            throw new InvalidResponseException('message', 111, $this->object);
        } catch (InvalidResponseException $e) {
            $this->assertEquals('message', $e->getMessage());
            $this->assertEquals(1234, $e->getCode());
