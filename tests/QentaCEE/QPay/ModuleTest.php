...
class QentaCEE_QPay_ModuleTest extends TestCase
{
    public function testClientConfig()
    {
        ...
        $this->assertEquals('QentaCEE_QPay', $aConfig['MODULE_NAME']);
    }
    ...
    public function testUserConfig()
    {
        ...
        $this->assertArrayHasKey('SHOP_ID', $aConfig['QentaCEEQPayConfig']);
        $this->assertArrayHasKey('LANGUAGE', $aConfig['QentaCEEQPayConfig']);
        $this->assertArrayHasKey('SECRET', $aConfig['QentaCEEQPayConfig']);
    }
}
