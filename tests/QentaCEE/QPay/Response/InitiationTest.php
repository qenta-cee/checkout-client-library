...
/**
 * Test class for QentaCEE_QPay_Response_Initiation.
...
class InitiationTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->object     = new Initiation($zendHttpResponse);
    }
    ...
    {
        $this->assertEquals(Initiation::STATE_SUCCESS, $this->object->getStatus());
    }
    ...
    public function testGetStatusFailed()
    {
        ...
        $this->assertEquals(Initiation::STATE_FAILURE, $this->object->getStatus());
    }
    ...
    protected function _fail200Response()
    {
        ...
        return new Initiation($zendHttpResponse);
    }
