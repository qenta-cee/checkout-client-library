...
/**
 * WirecardCEE_QMore_Response_Backend_DepositReversal test case.
 */
class WirecardCEE_QMore_Response_Backend_DepositReversalTest extends PHPUnit_Framework_TestCase
{
    ...
    protected $_paymentNumber = 123445;

    /**
     *
     * @var WirecardCEE_QMore_Response_Backend_DepositReversal
     */
    private $object;
