...
class WirecardCEE_QMore_Return_ReturnAbstractTestObject extends WirecardCEE_Stdlib_Return_ReturnAbstract
{
...
/**
 * Test class for WirecardCEE_Client_QMore_Return_Abstract.
 */
class WirecardCEE_QMore_Return_ReturnAbstractTest extends PHPUnit_Framework_TestCase
{

    /**
     *
     * @var WirecardCEE_QMore_Return_ReturnAbstractTestObject
     */
    protected $object;
    ...
    {
        $this->object = new WirecardCEE_QMore_Return_ReturnAbstractTestObject($this->_returnData);
    }
    ...
    public function testGetReturnedButUnsetArrayFields()
    {
        ...
        $object = new WirecardCEE_QMore_Return_ReturnAbstractTestObject($returnData);
        $object->getReturned();
