...
* Europe GmbH, FB-Nr: FN 195599 x, http://rhswinws64.wirecardcee.lan/PHP_Client_Library/Tests/confirm.php
*/
...
class WirecardCEE_QPay_FrontendClientTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testSetOrderNumber()
    {
        $orderNumber = '123321';
        $maxRetries  = 0;
        $sUrl        = 'http://rhswinws64.wirecardcee.lan/PHP_Client_Library/Tests/confirm.php';
