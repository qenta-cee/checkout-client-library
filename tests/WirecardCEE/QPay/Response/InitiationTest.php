 ...
 */
class WirecardCEE_QPay_Response_InitiationTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $zendHttpResponse = new \GuzzleHttp\Psr7\Response(200, Array(), 'pre=bla&redirectUrl=http://www.example.com&su=blub');
