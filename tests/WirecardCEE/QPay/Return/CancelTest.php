 ...
 */
class WirecardCEE_QPay_Return_CancelTest extends PHPUnit_Framework_TestCase
{

    /**
     * @var WirecardCEE_QPay_Return_Cancel
     */
    protected $object;
    ...
    {
        $this->object = new WirecardCEE_QPay_Return_Cancel($this->_returnData);
    }
